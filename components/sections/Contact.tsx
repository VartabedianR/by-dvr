...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 sm:py-32 lg:py-40">
      <div className="max-w-6xl mx-auto px-6 sm:px-110 lg:px-16">
        ...
        >
          <a
            ...
            className="text-2xl sm:text-3xl lg:text-4xl font-mono text-foreground hover:text-accent transition-colors break-all sm:break-normal"
          >
            {profile.email}
          </a>
        ...
        <motion.div {...fade(0.3)} className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="GitHub"
              className="inline-flex items-center justify-center w-11 h-11 rounded-full border border-border bg-surface/40 text-muted hover:text-foreground hover:border-foreground/30 transition-colors"
            >
