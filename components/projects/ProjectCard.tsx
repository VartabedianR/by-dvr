...
export function ProjectCard({ project, reversed = false }: ProjectCardProps) {
    ...
    return (
        <article className="grid grid-cols-12 gap-6 lg:gap-12 items-center">
            {/* Bloc images */}
            <motion.div
                {...fade(0)}
                className={cn(
                            ...
                            <div className="flex gap-3">
                                {project.images.map((img, idx) => (
                                    <button
                                        ...
                                        className={cn(
                                            "relative flex-1 rounded-lg overflow-hidden border-2 transition-all",
                                            idx === activeIndex
                                    ...
                                    >
                                        <Image
                                            ...
                                            width={400}
                                            height={240}
                                            className="w-full h-20 sm:h-24 object-cover block"
                                        />
                                    </button>
                                ))}
                            </div>
